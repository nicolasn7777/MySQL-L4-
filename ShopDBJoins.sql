...
SELECT 
Customers.LName AS CustomerLN, 
Customers.FName AS CustomerFN, 
Customers.MName AS CustomerMN, 
Employees.LName AS EmployeeLN, 
Employees.FName AS EmployeeFN, 
Employees.MName AS EmployeeMN, 
TotalPrice
FROM Employees
JOIN Orders
